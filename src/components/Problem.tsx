    ...
    return (
        <section className="py-24 bg-background">
            <div className="container mx-auto px-6 max-w-4xl text-center">
                ...
                >
                    You handle it all. You follow through. You make it work.
                    <span className="font-serif italic text-gold-dark block mt-2">And yet, something inside still feels unfulfilled?</span>
                </motion.h2>
